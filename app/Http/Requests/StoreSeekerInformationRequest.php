    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'information.cover_letter' => ['max:1000'],
             ...
             'education.*.date.month' => ['sometimes','in:yes,no'],
             'education.*.date.year' => ['sometimes','in:yes,no'],
            ...
            'experience.*.date.month' => ['required','in:yes,no'],
            'experience.*.date.year' => ['required','in:yes,no'],
            'experience.*.finishDate.day' => ['sometimes','in:yes,no'],
            'experience.*.finishDate.month' => ['required','in:yes,no'],
